...
from geo_fault_lines import detect_lineaments

__all__ = [
    # niepowiązany mini-eksperyment (osobne API, patrz examples/example_usage.py)
    "Proximalizer",
    "Phi2Interface",
    # rdzeń matematyczny filtra phi -- koherencja "szybka" (usrednione wektory)
    "gradient_field",
    "coherence_lambda",
    "flow_tau",
    "defects_rho",
    "phi_composite",
    "normalize",
    # rdzeń matematyczny filtra phi -- koherencja "rygorystyczna" (structure
    # tensor + kierunek); domenowo-neutralna: lineamenty geologiczne,
    # linie papilarne, naczynia siatkówki, włókna tkanki -- patrz
    # docstring w phi_core.py
    "structure_tensor_coherence",
    "lineament_score",
    "orientation_to_rgb",
    ...
    "phi_structure_map",
    "process_directory",
    # zastosowanie: lineamenty geologiczne (uskoki, rzeki, drogi) na
    # zdjęciach satelitarnych/DEM
    "detect_lineaments",
]

...
`coherence_lambda()`, tylko prawdziwy **structure tensor**
(`phi_core.py:structure_tensor_coherence()` — macierz momentów drugiego
rzędu gradientu, koherencja i kierunek z wartości własnych).
